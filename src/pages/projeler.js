  ...
  return (
    <div className="bg-background font-body text-on-background antialiased selection:bg-primary-container selection:text-on-primary-container min-h-screen flex flex-col">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl shadow-[0_8px_32px_rgba(109,94,0,0.08)]">
        <div className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-8 font-headline font-bold tracking-tight">
            ...
            <a className="text-zinc-900 dark:text-white border-b-4 border-yellow-400 pb-1" href="/projeler">{t.nav.projects}</a>
                ...
                {project.image ? (
                  <div className="relative overflow-hidden aspect-[4/3] shrink-0">
                    ...
                    <div className="absolute top-4 left-4 w-8 h-8 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center">
                      <span className="text-[11px] font-black font-headline text-zinc-900">{String(i + 1).padStart(2, "00")}</span>
                    </div>
                  </div>
                ) : (
                  <div className="relative aspect-[4/3] shrink-0 bg-surface-container-highest flex items-center justify-center">
                    <span className="text-5xl font-black font-headline text-outline-variant/30">{String(i + 1).padStart(2, "00")}</span>
                  </div>
                )}
      ...
      <div className="md:hidden fixed bottom-6 left-6 right-6 z-50 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl rounded-2xl shadow-2xl flex justify-around items-center p-4">
        ...
        <a className="flex flex-col items-center gap-1 text-zinc-900 dark:text-white border-b-4 border-yellow-400 pb-1" href="/projeler">
