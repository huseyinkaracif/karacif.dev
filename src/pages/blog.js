...
export default function Blog({ data }) {
  ...
  return (
    <div className="bg-background text-on-background font-body antialiased min-h-screen flex flex-col">
      ...
      {/* Footer */}
      <footer className="w-full py-8 md:py-12 px-6 pb-32 md:pb-8 bg-zinc-50">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6 max-w-7xl mx-auto">
          <div className="flex flex-col items-center md:items-start gap-2">
            <div className="font-black text-zinc-900 font-headline text-xl">Karacif.dev</div>
            <div className="font-['Inter'] text-sm tracking-wide text-zinc-500">© 2026 Hüseyin Karacif. Senior Software Developer.</div>
          </div>
